  ...
  return (
    <Card className="w-full max-w-md shadow-2xl animate-fadeIn">
      <CardHeader className="text-center">
        ...
        <CardTitle className="font-headline text-3xl text-primary">Crear Cuenta de Lector</CardTitle>
        <CardDescription>Únete a nuestra comunidad de amantes de los libros.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
