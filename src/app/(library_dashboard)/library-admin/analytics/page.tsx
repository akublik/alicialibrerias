// src/app/(library_dashboard)/library-admin/analytics/page.tsx
"use client";
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-lg text-foreground/80">
                        Entiende qué están buscando los lectores para optimizar tu catálogo.
                    </p>
                </div>
            </div>
                ...
                <Tabs defaultValue="top-searches">
                    ...
                    <TabsContent value="top-searches">
                        <Card className="shadow-lg">
                            <CardHeader>
                                <CardTitle>Top de Búsquedas Globales</CardTitle>
                                <CardDescription>Los términos más buscados por los usuarios en toda la plataforma. Úsalo como inspiración.</CardDescription>
                            </CardHeader>
                            <CardContent>
