...
import { Loader2, BookHeart, BookX } from "lucide-react";
import { db } from "@/lib/firebase";
import { collection, onSnapshot, query } from "firebase/firestore";
import type { DigitalBook, User } from "@/types";
    ...
    <div className="container mx-auto px-4 py-8 md:py-12 animate-fadeIn">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="font-headline text-2xl font-semibold text-foreground">Tu biblioteca está vacía</h3>
          <p className="text-muted-foreground mt-2">
            Los libros digitales que adquieras aparecerán aquí.
          </p>
        </div>
      )}
    </div>
